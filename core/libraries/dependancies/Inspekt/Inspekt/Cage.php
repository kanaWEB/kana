...
class Inspekt_Cage implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    public function _parseAndApplyAutoFilters($conf_file, $conf_section)
    {
        if (isset($conf_file)) {
    ...
    public function _applyAutoFilters()
    {
    ...
    public function _keyExistsRecursive($keys, $data_array)
    {
    ...
    public function _getValueRecursive($keys, $data_array, $level = 0)
    {
        $thiskey = current($keys);
    ...
    public function _setValueRecursive($keys, $val, $data_array, $level = 0)
    {
        $thiskey = current($keys);
