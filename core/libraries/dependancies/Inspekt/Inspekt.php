...
class Inspekt
{
     ...
     * @param bool   $strict      whether or not to nullify the superglobal array
     *
     * @return Inspekt_Cage
     *
     * @assert()
     ...
     *
     * @param string $config_file
     * @param bool   $strict      whether or not to nullify the superglobal
     *
     ...
     * @return array
     */
    protected static function _walkArray($input, $method, $classname = null)
    {
        if (!isset($classname)) {
            $classname = __CLASS__;
        }
    ...
    {
        $is = false;
        $is = self::isArrayObject($arr) || is_array($arr);
     ...
     *
     * @param mixed $value
     * @param int   $allow bitfield for ISPK_HOST_ALLOW_DNS, ISPK_HOST_ALLOW_IP, ISPK_HOST_ALLOW_LOCAL
     *
     * @return bool
     *
     * @tag validator
