...
class RainTPL
{
    ...
    // -------------------------
         ...
         * @var array
         */
        public static $path_replace_list = array('a', 'img', 'link', 'script', 'input');
         ...
         * @var unknown_type
         */
        public static $black_list = array('\$this', 'raintpl::', 'self::', '_SESSION', '_SERVER', '_ENV',  'eval', 'exec', 'unlink', 'rmdir');
     ...
     */
    public function cache($tpl_name, $expire_time = self::CACHE_EXPIRE_TIME, $cache_id = null)
    {
