...
class Entity extends SQLKana
{
    ...
    public function __construct($type, $entity)
    {
        ...
        //1. If the database doesn't already exists create it
        //2. If the database
    ...
    private function setCoreTable($table_name)
    {
    ...
    private function setConfigTable($object_name, $master_dir)
    {
        $db_fields['id'] = "key";
        $db_fields['uid'] = "int";
    ...
    private function setElectronicTable($object_name)
    {
    ...
    private function setActionTable($object_name)
    {
    ...
    private function setDataTable($db_name)
    {
        $db_fields = array(
            "id"   => "key",
            "data_id" => "text",
    ...
    private function md2fields($dir, $db_fields, $inputs_file)
    {
