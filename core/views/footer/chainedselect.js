...
actions_html = $("#actions0").html();

//Actions
for(i = 0;i <= id_actions;i++ ){
$("#plugin_actions"+i).chained("#object_actions"+i);
$("#objects_actions"+i).chained("#actions"+i);
}
...
function rechained(new_id){
	$("#objects_actions"+new_id).chained("#plugins_actions"+new_id);
	$("#actions"+new_id).chained("#objects_actions"+new_id);
	refresh_actions();
}
